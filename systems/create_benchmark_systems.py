...
if __name__ == "__main__":
    ...
    for n, p, m, precision, structure, input_length in product(
        ns, ps, ms, precisions, structures, input_lengths
    ):
        print(n, p, m, precision, input_length)
        filename = path / f"n{n}p{p}m{m}d{input_length}{precision}{structure}"
