...
int main(int argc, char const *argv[])
{
    ...
    NoProcess<double> nonempty_state_double(A.get(), B_npy.data<double>(), C_npy.data<double>(), D_npy.data<double>(), B_npy.shape[0], B_npy.shape[1], C_npy.shape[0], matstruct);
